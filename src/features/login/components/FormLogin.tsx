      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-neutral-200/70 dark:border-neutral-800 bg-white/60 dark:bg-neutral-900/60 shadow-[0_8px_30px_rgba(0,0,0,0.06)] backdrop-blur p-6 sm:p-8">
          <div className="mb-6 text-center">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-blue-500 text-white font-semibold">
              PR
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-neutral-300/80 dark:border-neutral-700 bg-white/80 dark:bg-neutral-900 px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-indigo-500/70 focus:border-indigo-500 transition"
                value={email}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full rounded-xl border border-neutral-300/80 dark:border-neutral-700 bg-white/80 dark:bg-neutral-900 px-3 py-2.5 pr-10 text-sm outline-none focus:ring-2 focus:ring-indigo-500/70 focus:border-indigo-500 transition"
                  value={password}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full rounded-xl bg-indigo-600 text-white text-sm font-medium py-2.5 hover:bg-indigo-700 active:bg-indigo-800 disabled:opacity-60 disabled:cursor-not-allowed transition"
            >
